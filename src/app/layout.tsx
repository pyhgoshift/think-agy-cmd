  ...
  return (
    <html lang="en" className="dark">
      ...
      >
        <AuthWrapper>
          <Navigation />
          <main className="flex-1 flex flex-col h-full overflow-hidden bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-zinc-800 via-zinc-950 to-black relative pb-[70px] md:pb-0">
