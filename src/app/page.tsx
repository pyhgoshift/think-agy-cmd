  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950 p-6 max-h-screen">
      ...
      <div className="flex-1 bg-zinc-900/50 rounded-2xl border border-zinc-800/50 p-4 flex flex-col min-h-0 relative overflow-hidden">
        <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col gap-4 p-4 pb-20">
          {messages.map((msg) => (
            <motion.div 
              key={msg.id}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-zinc-900 via-zinc-900/95 to-transparent">
          <div className="flex gap-2 max-w-4xl mx-auto">
            ...
            <button 
              onClick={sendMessage}
              className="bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-xl font-medium transition-colors shadow-lg shadow-primary/20 flex items-center justify-center"
            >
              <Send size={20} />
            </button>
          </div>
